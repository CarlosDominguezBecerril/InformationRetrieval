...
def init_distributed_mode(params):
    ...
    print("Is slurm job:", is_slurm_job)
    print("Has local rank:", has_local_rank)
    ...
    if is_slurm_job and has_local_rank:
        ...
        # params.world_size = len(os.environ["SLURM_JOB_GPUS"].split(","))

        print("Local rank:", params.local_rank )
        print("Global rank:", params.global_rank )
        ...
        print("Main address:", params.main_addr)
