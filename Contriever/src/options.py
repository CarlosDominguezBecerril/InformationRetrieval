...
class Options:
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--augmentation", type=str, default="delete")
        self.parser.add_argument("--prob_augmentation", type=float, default=0.1)
        ...
        self.parser.add_argument("--warmup_steps", type=int, default=20000)
        ...
        self.parser.add_argument(
            "--eval_freq", type=int, default=50000, help="evaluate model every <eval_freq> steps during training"
        )
